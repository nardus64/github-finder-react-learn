...
function saveme(){
	...
	if (Numf != 0 && lexdate != " "){
		var n = "food" + (localStorage.length + 1);
...
function popAray(){
	...
	for(i=0; i<10; i++){
	var localvalues = localStorage.getItem("food");
...
function newExpens(){
var lexexpense = " ";
alert("New eats to be added here, chrome remember but the rest not");
}
