...
// this draw block2 animated for computer move	 2AC
 function drawSomething2ac() 
	{      	 
         ctx.fillStyle="pink";
		   a ++;
		 ctx.fillRect(block2V , blockH1, blocksize, blocksize); 
		if (a < 49) {  
...
{	  ctx.moveTo(blockH1, block1V);
	  ctx.lineTo(blockH2, block2V);	
	  ctx.moveTo(blockH2, block1V);
	  ctx.lineTo(blockH1, block2V);
	}
function drawendline2(){
	  ctx.moveTo(blockH2, block1V);
	  ctx.lineTo(blockH3, block2V);
	  ctx.moveTo(blockH2, block2V);
	  ctx.lineTo(blockH3, block1V);
	}
	  
function drawendline3(){
	  ctx.moveTo(blockH3, block1V);
	  ctx.lineTo(blockH4, block2V);
	  ctx.moveTo(blockH3, block2V);
	  ctx.lineTo(blockH4, block1V);	
	}
function drawendline4(){
	  ctx.moveTo(blockH1, block2V);
	  ctx.lineTo(blockH2, block3V);
	  ctx.moveTo(blockH1, block3V);
	  ctx.lineTo(blockH2, block2V);	
	}

function drawendline5(){
	  ctx.moveTo(blockH2, block2V);
	  ctx.lineTo(blockH3, block3V);
	  ctx.moveTo(blockH2, block3V);
	  ctx.lineTo(blockH3, block2V);
}
function drawendline6(){
	  ctx.moveTo(blockH2, block3V);
	  ctx.lineTo(blockH3, block4V);
	  ctx.moveTo(blockH3, block3V);
	  ctx.lineTo(blockH2, block4V);
}  
function drawblock() {
...
function computerMove3(){
	if (compmovedone = "n"){
	if (block3Clicks < randomClickNo)
	{alert("in computermove3 " + block3Clicks );
	drawSomething3('pink');
